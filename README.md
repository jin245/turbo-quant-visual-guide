...
- **TurboQuant は同じメモリ予算で最も低い IP Error** — 例えば 400 ビットで比較すると、Lloyd-Max 4-bit は 0.003、Hybrid m=100,b=4 は 0.076、TurboQuant b=3,m=200 は 0.018。Lloyd-Max が最良だが、TurboQuant は再構成品質を維持しつつ不偏推定も実現している点が異なる
